...
// Make sure that you do not import logger from
	...
	public List<Book> getAuthorBooks(String author) {
		String qStr = "select B1 from Book b1 WHERE b1.author=:pAuthor"; //pAuthor
		TypedQuery<Book> query = entityManager.createQuery(qStr, Book.class);
	...
	//createNamedQuery method below is working to get the results 
	@Override
	public List<Book> getAllBooks() {
		Query query = entityManager.createNamedQuery("getAllBooks");
		@SuppressWarnings
		("unchecked") List<Book> bookList = query.getResultList();
		return bookList;
	}
	@Override
